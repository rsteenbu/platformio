...
//----------------------------------------------------------------------------
    ...
    const uint8_t kPanelType = SMARTMATRIX_HUB75_64ROW_MOD32SCAN;
    const uint16_t MATRIX_TILE_WIDTH = 256; // width of EACH NEOPIXEL MATRIX (not total display)
    const uint16_t MATRIX_TILE_HEIGHT= 128; // height of each matrix
    #else
    const uint8_t kPanelType = SM_PANELTYPE_HUB75_64ROW_MOD32SCAN;
    const uint16_t MATRIX_TILE_WIDTH = 512; // width of EACH NEOPIXEL MATRIX (not total display)
    ...
    const uint16_t kMatrixWidth =  MATRIX_TILE_WIDTH *  MATRIX_TILE_H;
    const uint16_t kMatrixHeight = MATRIX_TILE_HEIGHT * MATRIX_TILE_V;
